...
def run_pipeline(clinical_text: str, trial_json: dict, model: str = "phi4-mini") -> dict:
    """
    ...
    result = evaluate_eligibility(patient, parsed_trial.criteria, parsed_trial.nct_id)
